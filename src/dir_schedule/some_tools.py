...
class DataAI:
    ...
    def if_error_ai_get_text_for_birthday_user(self, first_name: str, title: str) -> str:
        """If error with AI - create own content"""
...
class AskingMoney:
    ...
    async def send_message_to_user(
            self, chat_id: int, text: str, url: str = None, filename: str = None,
            reply_markup: Optional[
                Union[InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardRemove, ForceReply]] = None
    ) -> bool:
        """Send message with photo to user"""
        for n in range(3):
            try:
                ...
                return True
    ...
    async def response_ai(self, user: User, days_to_birthday: int) -> Dict[str, Dict[str, Union[str, int]]]:
        """Response AI to get text and image for asking money from user"""
        ...
