...
class TestMenu:
    ...
    @pytest.mark.asyncio
    async def test_main_menu_display(self, mock_message):
        ...
        try:
            ...
            # Якщо функція не існує, перевіряємо що модуль можна імпортувати
            try:
                import src.bot_app.dir_menu.menu

                assert True
            except ImportError:
                pytest.skip("Модуль menu недоступний")

    @pytest.mark.asyncio
    async def test_admin_menu_display(self, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_birthday_menu_display(self, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_menu_navigation(self, mock_callback):
    ...
    @pytest.mark.asyncio
    async def test_menu_state_management(self, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_menu_data_loading(self, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_menu_personalization(self, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_menu_error_handling(self, mock_message):
    ...
    @pytest.mark.asyncio
    async def test_menu_accessibility(self, mock_message):
