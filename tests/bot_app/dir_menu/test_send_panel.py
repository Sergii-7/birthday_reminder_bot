...
class TestSendPanel:
    ...
    @pytest.mark.asyncio
    async def test_send_text_message(self, mock_bot, mock_message_data):
    ...
    @pytest.mark.asyncio
    async def test_send_photo_message(self, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_send_document_message(self, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_broadcast_message(self, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_send_birthday_notification(self, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_send_admin_report(self, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_send_with_keyboard(self, mock_bot):
    ...
    @pytest.mark.asyncio
    async def test_send_panel_error_handling(self, mock_bot):
        ...
        try:
            ...
            pytest.skip("Модуль send_panel недоступний")
    ...
    @pytest.mark.asyncio
    async def test_message_queue_management(self, mock_bot):
